...
>
  <head>
    ...
    <title>Tambah Buku Baru | BankBook </title>
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="col-xxl">
                    <div class="card mb-4">
                      ...
                      <div class="card-body">
                        <form enctype='multipart/form-data' method="POST" autocomplete="off" action="{{route('paddbook')}}">
                            @csrf
                          <div class="row mb-3">
                        ...
                        @enderror
                          ...
                          <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="formFile">File PDF</label>
                            <div class="col-sm-10">
                              <div class="input-group input-group-merge">
                                <span id="basic-icon-default-fullname2" class="input-group-text"
